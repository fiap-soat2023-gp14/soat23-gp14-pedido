...
import {OrderEntity} from "../../../infrastructure/adapters/repository/entity/OrderEntity";
...
export default class OrderService {
    ...
    public async createOrder(orderCreationDTO: OrderCreationDTO) {
        ...
        for (const item of orderCreationDTO.items) {
            ...
            order.total = order.total.plus(new Decimal(orderItem.product.price).mul(orderItem.quantity));
        }
